...
#include "inner_loop_controller.h"
...
/*  This Timer Thread controls the motor and acquires data */
    ...
    //  Initialize interfaces before allowing IRQ
    	...
    	conC_Encoder_initialize(myrio_session, &encC0, 0);	// initialize encoder
        conC_Encoder_initialize(myrio_session, &encC1, 1);	// initialize encoder
